...
static void qmp_marshal_output_query_chardev_backends(ChardevBackendInfoList * ret_in, QObject **ret_out, Error **errp)
{
    ...
    v = qmp_output_get_visitor(mo);
    visit_type_ChardevBackendInfoList(v, &ret_in, "unused", errp);
    if (!error_is_set(errp)) {
        *ret_out = qmp_output_get_qobject(mo);
    }
    qmp_output_visitor_cleanup(mo);
...
int qmp_marshal_input_query_chardev_backends(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    retval = qmp_query_chardev_backends(errp);
    if (!error_is_set(errp)) {
        qmp_marshal_output_query_chardev_backends(retval, ret, errp);
    }
...
static void qmp_marshal_output_query_iothreads(IOThreadInfoList * ret_in, QObject **ret_out, Error **errp)
{
    ...
    v = qmp_output_get_visitor(mo);
    visit_type_IOThreadInfoList(v, &ret_in, "unused", errp);
    if (!error_is_set(errp)) {
        *ret_out = qmp_output_get_qobject(mo);
    }
    qmp_output_visitor_cleanup(mo);
...
int qmp_marshal_input_query_iothreads(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    retval = qmp_query_iothreads(errp);
    if (!error_is_set(errp)) {
        qmp_marshal_output_query_iothreads(retval, ret, errp);
    }
...
int qmp_marshal_input_block_passwd(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    mi = qmp_input_visitor_new_strict(QOBJECT(args));
    v = qmp_input_get_visitor(mi);
    visit_start_optional(v, &has_device, "device", errp);
    if (has_device) {
        visit_type_str(v, &device, "device", errp);
    }
    visit_end_optional(v, errp);
    visit_start_optional(v, &has_node_name, "node-name", errp);
    if (has_node_name) {
        visit_type_str(v, &node_name, "node-name", errp);
    }
    visit_end_optional(v, errp);
    ...
    qmp_block_passwd(has_device, device, has_node_name, node_name, password, errp);

out:
    md = qapi_dealloc_visitor_new();
    v = qapi_dealloc_get_visitor(md);
    visit_start_optional(v, &has_device, "device", NULL);
    if (has_device) {
        visit_type_str(v, &device, "device", NULL);
    }
    visit_end_optional(v, NULL);
    visit_start_optional(v, &has_node_name, "node-name", NULL);
    if (has_node_name) {
...
int qmp_marshal_input_block_resize(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    qmp_block_resize(has_device, device, has_node_name, node_name, size, errp);
...
int qmp_marshal_input_blockdev_snapshot_sync(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    visit_start_optional(v, &has_snapshot_node_name, "snapshot-node-name", errp);
    if (has_snapshot_node_name) {
        visit_type_str(v, &snapshot_node_name, "snapshot-node-name", errp);
    }
    visit_end_optional(v, errp);
    visit_start_optional(v, &has_format, "format", errp);
    if (has_format) {
    ...
    qmp_blockdev_snapshot_sync(has_device, device, has_node_name, node_name, snapshot_file, has_snapshot_node_name, snapshot_node_name, has_format, format, has_mode, mode, errp);
...
out:
    ...
    visit_start_optional(v, &has_snapshot_node_name, "snapshot-node-name", NULL);
    if (has_snapshot_node_name) {
...
int qmp_marshal_input_block_commit(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    visit_end_optional(v, errp);
    visit_start_optional(v, &has_top, "top", errp);
    if (has_top) {
    ...
    qmp_block_commit(device, has_base, base, has_top, top, has_speed, speed, errp);
...
out:
    ...
    visit_end_optional(v, NULL);
    visit_start_optional(v, &has_top, "top", NULL);
    if (has_top) {
...
static void qmp_marshal_output_query_named_block_nodes(BlockDeviceInfoList * ret_in, QObject **ret_out, Error **errp)
{
    ...
    v = qmp_output_get_visitor(mo);
    visit_type_BlockDeviceInfoList(v, &ret_in, "unused", errp);
    if (!error_is_set(errp)) {
        *ret_out = qmp_output_get_qobject(mo);
    }
    qmp_output_visitor_cleanup(mo);
...
int qmp_marshal_input_query_named_block_nodes(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    retval = qmp_query_named_block_nodes(errp);
    if (!error_is_set(errp)) {
        qmp_marshal_output_query_named_block_nodes(retval, ret, errp);
    }
...
int qmp_marshal_input_dump_guest_memory(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    visit_start_optional(v, &has_format, "format", errp);
    if (has_format) {
        visit_type_DumpGuestMemoryFormat(v, &format, "format", errp);
    }
    visit_end_optional(v, errp);
    qmp_input_visitor_cleanup(mi);
    ...
    qmp_dump_guest_memory(paging, protocol, has_begin, begin, has_length, length, has_format, format, errp);
...
static void qmp_marshal_output_query_dump_guest_memory_capability(DumpGuestMemoryCapability * ret_in, QObject **ret_out, Error **errp)
{
    ...
    v = qmp_output_get_visitor(mo);
    visit_type_DumpGuestMemoryCapability(v, &ret_in, "unused", errp);
    if (!error_is_set(errp)) {
        *ret_out = qmp_output_get_qobject(mo);
    }
    qmp_output_visitor_cleanup(mo);
...
int qmp_marshal_input_query_dump_guest_memory_capability(Monitor *mon, const QDict *qdict, QObject **ret)
{
    ...
    retval = qmp_query_dump_guest_memory_capability(errp);
    if (!error_is_set(errp)) {
        qmp_marshal_output_query_dump_guest_memory_capability(retval, ret, errp);
    }
