...
{
    BLOCKDEV_DRIVER_FILE = 0,
    BLOCKDEV_DRIVER_HTTP = 1,
    BLOCKDEV_DRIVER_HTTPS = 2,
    BLOCKDEV_DRIVER_FTP = 3,
    BLOCKDEV_DRIVER_FTPS = 4,
    BLOCKDEV_DRIVER_TFTP = 5,
    BLOCKDEV_DRIVER_VVFAT = 6,
    BLOCKDEV_DRIVER_BLKDEBUG = 7,
    BLOCKDEV_DRIVER_BLKVERIFY = 8,
    BLOCKDEV_DRIVER_BOCHS = 9,
    BLOCKDEV_DRIVER_CLOOP = 10,
    BLOCKDEV_DRIVER_COW = 11,
    BLOCKDEV_DRIVER_DMG = 12,
    BLOCKDEV_DRIVER_PARALLELS = 13,
    BLOCKDEV_DRIVER_QCOW = 14,
    BLOCKDEV_DRIVER_QCOW2 = 15,
    BLOCKDEV_DRIVER_QED = 16,
    BLOCKDEV_DRIVER_RAW = 17,
    BLOCKDEV_DRIVER_VDI = 18,
    BLOCKDEV_DRIVER_VHDX = 19,
    BLOCKDEV_DRIVER_VMDK = 20,
    BLOCKDEV_DRIVER_VPC = 21,
    BLOCKDEV_DRIVER_QUORUM = 22,
    BLOCKDEV_DRIVER_MAX = 23,
} BlockdevDriver;
